...
def main():
    ...
    grabzIt = GrabzItClient.GrabzItClient("NjI5YzIzZDVhYjgzNGU1M2JmNWYxYTQzMzU1NmEzYmI=", "PT1xIFQ/Pxk/Pz8KHWE/Akk/Pz8/Pz8/aDoXG1AxalU=") #Using Grabzit API to convert tweet to image
